...
styleEl.textContent = `
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .hamburger {
    width: 60px; height: 60px; /* Bigger button size for a clear desktop appearance */
    border-radius: 20px;
    border: none;
    background: white;
    ...
    align-items: flex-end; /* Perfectly flushes the top two lines right */
    gap: 6px;
    padding: 0 16px; /* Balance spacing around lines */
    flex-shrink: 0;
  }
  
  /* Top two lines: Full-width */
  .hamburger span {
    display: block;
    width: 26px;
    height: 4px;
  ...
  /* Bottom third line: Staggered shorter half-width on the left edge */
